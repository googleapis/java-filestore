...
public final class CloudFilestoreServiceProto {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          + "<google/cloud/filestore/v1beta1/cloud_filestore_service.proto\022\036google.cloud.fil"
          + "estore.v1beta1\032\034google/api/annotations.p"
          + "roto\032\027google/api/client.proto\032\037google/ap"
          + "i/field_behavior.proto\032\031google/api/resource.proto\032#google/longrunning/operations.proto\032"
          + " google/protobuf/field_mask.proto\032\037google/protobuf/timestamp.proto\032\036google/protobuf/wrappers.proto\"\334\001\n\r"
          + "NetworkConfig\022\017\n"
          + "\007network\030\001 \001(\t\022H\n"
          + "\005modes\030\003"
          + " \003(\01629.google.cloud.filestore.v1beta1.NetworkConfig.AddressMode\022\031\n"
          ...
          + "\tMODE_IPV4\020\001\"\306\001\n"
          + "\017FileShareConfig\022\014\n"
          + "\004name\030\001 \001(\t\022\023\n"
          + "\013capacity_gb\030\002 \001(\003\0228\n\r"
          + "source_backup\030\t \001(\tB\037\372A\034\n"
          + "\032file.googleapis.com/BackupH\000\022L\n"
          + "\022nfs_export_options\030\010"
          + " \003(\01320.google.cloud.filestore.v1beta1.NfsExportOptionsB\010\n"
          + "\006source\"\207\003\n"
          + "\020NfsExportOptions\022\021\n"
          + "\tip_ranges\030\001 \003(\t\022P\n"
          + "\013access_mode\030\002"
          + " \001(\0162;.google.cloud.filestore.v1beta1.NfsExportOptions.AccessMode\022P\n"
          + "\013squash_mode\030\003"
          + " \001(\0162;.google.cloud.filestore.v1beta1.NfsExportOptions.SquashMode\022\020\n"
          ...
          + "\013ROOT_SQUASH\020\002\"\204\007\n"
          + "\010Instance\022\021\n"
          + "\004name\030\001 \001(\tB\003\340A\003\022\023\n"
          + "\013description\030\002 \001(\t\022B\n"
          + "\005state\030\005"
          + " \001(\0162..google.cloud.filestore.v1beta1.Instance.StateB\003\340A\003\022\033\n"
          ...
          + "\004tier\030\010 \001(\0162-.google.cloud.filestore.v1beta1.Instance.Tier\022D\n"
          + "\006labels\030\t"
          + " \003(\01324.google.cloud.filestore.v1beta1.Instance.LabelsEntry\022D\n"
          + "\013file_shares\030\n"
          + " \003(\0132/.google.cloud.filestore.v1beta1.FileShareConfig\022?\n"
          + "\010networks\030\013"
          + " \003(\0132-.google.cloud.filestore.v1beta1.NetworkConfig\022\014\n"
          + "\004etag\030\014 \001(\t\0226\n\r"
          + "satisfies_pzs\030\r"
          + " \001(\0132\032.google.protobuf.BoolValueB\003\340A\003\032-\n"
          ...
          + "\016HIGH_SCALE_SSD\020\006:_\352A\\\n"
          + "\034file.googleapis.com/Instance\022<projects/{project}/locations/{location}/instances/{instance}\"\255\001\n"
          ...
          + "\010instance\030\003"
          + " \001(\0132(.google.cloud.filestore.v1beta1.InstanceB\003\340A\002\"H\n"
          ...
          + "\010instance\030\002"
          + " \001(\0132(.google.cloud.filestore.v1beta1.InstanceB\003\340A\002\"\347\001\n"
          ...
          + "\tinstances\030\001 \003(\0132(.google.cloud.filestore.v1beta1.Instance\022\027\n"
          ...
          + "\005state\030\003"
          + " \001(\0162,.google.cloud.filestore.v1beta1.Backup.StateB\003\340A\003\0224\n"
          + "\013create_time\030\004 \001(\0132\032.google.protobuf.TimestampB\003\340A\003\022B\n"
          + "\006labels\030\005"
          + " \003(\01322.google.cloud.filestore.v1beta1.Backup.LabelsEntry\022\030\n"
          ...
          + " \001(\0162-.google.cloud.filestore.v1beta1.Instance.TierB\003\340A\003\022\033\n"
          + "\016download_bytes\030\013 \001(\003B\003\340A\003\0226\n\r"
          + "satisfies_pzs\030\014 \001(\0132\032.google.protobuf.BoolValueB\003\340A\003\032-\n"
          + "\013LabelsEntry\022\013\n"
          + "\003key\030\001 \001(\t\022\r\n"
          ...
          + "\032file.googleapis.com/Backup\0228projects/{project}/locations/{location}/backups/{backup}\"\245\001\n"
          + "\023CreateBackupRequest\0229\n"
          + "\006parent\030\001 \001(\tB)\340A\002\372A#\n"
          + "!locations.googleapis.com/Location\022;\n"
          + "\006backup\030\002"
          + " \001(\0132&.google.cloud.filestore.v1beta1.BackupB\003\340A\002\022\026\n"
          ...
          + "\006backup\030\001"
          + " \001(\0132&.google.cloud.filestore.v1beta1.BackupB\003\340A\002\0224\n"
          ...
          + "ListInstances\0224.google.cloud.filestore.v1bet"
          + "a1.ListInstancesRequest\0325.google.cloud.filestore.v1beta1.ListInstancesResponse\"C\202\323\344\223\0024\0222/v1beta1/{parent=projects/*/locations/*}/instances\332A\006parent\022\256\001\n"
          + "\013GetInstance\0222.google.cloud.filestore.v1beta1.Get"
          + "InstanceRequest\032(.google.cloud.filestore"
          + ".v1beta1.Instance\"A\202\323\344\223\0024\0222/v1beta1/{name=projects/*/locations/*/instances/*}\332A\004name\022\377\001\n"
          + "\016CreateInstance\0225.google.cloud.filestore.v1beta1.CreateInstanceRequest\032\035"
          + ".google.longrunning.Operation\"\226\001\202\323\344\223\002>\"2"
          + "/v1beta1/{parent=projects/*/locations/*}/instances:\010instance\332A\033parent,instance,instance_id\312A1\n"
          + "\010Instance\022%google.cloud.common.OperationMetadata\022\201\002\n"
          + "\016UpdateInstance\0225.google.cloud.filestore.v1beta1.Updat"
          + "eInstanceRequest\032\035.google.longrunning.Op"
          + "eration\"\230\001\202\323\344\223\002G2;/v1beta1/{instance.name=projects/*/locations/*/instances/*}:\010instance\332A\024instance,update_mask\312A1\n"
          + "\010Instance\022%google.cloud.common.OperationMetadata\022\343\001\n"
          + "\017RestoreInstance\0226.google.cloud.filestore.v1beta1.RestoreInstanceRequest\032\035"
          + ".google.longrunning.Operation\"y\202\323\344\223\002?\":/v1beta1/{name=projects/*/locations/*/instances/*}:restore:\001*\312A1\n"
          + "\010Instance\022%google.cloud.common.OperationMetadata\022\353\001\n"
          + "\016DeleteInstance\0225.google.cloud.filestore.v1b"
          + "eta1.DeleteInstanceRequest\032\035.google.long"
          + "running.Operation\"\202\001\202\323\344\223\0024*2/v1beta1/{name=projects/*/locations/*/instances/*}\332A\004name\312A>\n"
          + "\025google.protobuf.Empty\022%google.cloud.common.OperationMetadata\022\271\001\n"
          + "\013ListBackups\0222.google.cloud.filestore.v1beta1."
          + "ListBackupsRequest\0323.google.cloud.filest"
          + "ore.v1beta1.ListBackupsResponse\"A\202\323\344\223\0022\0220/v1beta1/{parent=projects/*/locations/*}/backups\332A\006parent\022\246\001\n"
          + "\tGetBackup\0220.google.cloud.filestore.v1beta1.GetBackupReque"
          + "st\032&.google.cloud.filestore.v1beta1.Backup\"?\202\323\344\223\0022\0220/v1beta1/{name=projects/*/locations/*/backups/*}\332A\004name\022\361\001\n"
          + "\014CreateBackup\0223.google.cloud.filestore.v1beta1.Cr"
          + "eateBackupRequest\032\035.google.longrunning.O"
          + "peration\"\214\001\202\323\344\223\002:\"0/v1beta1/{parent=projects/*/locations/*}/backups:\006backup\332A\027parent,backup,backup_id\312A/\n"
          + "\006Backup\022%google.cloud.common.OperationMetadata\022\345\001\n"
          + "\014DeleteBackup\0223.google.cloud.filestore.v1beta"
          + "1.DeleteBackupRequest\032\035.google.longrunni"
          + "ng.Operation\"\200\001\202\323\344\223\0022*0/v1beta1/{name=projects/*/locations/*/backups/*}\332A\004name\312A>\n"
          + "\025google.protobuf.Empty\022%google.cloud.common.OperationMetadata\022\363\001\n"
          + "\014UpdateBackup\0223.google.cloud.filestore.v1beta1.Update"
          + "BackupRequest\032\035.google.longrunning.Opera"
          + "tion\"\216\001\202\323\344\223\002A27/v1beta1/{backup.name=projects/*/locations/*/backups/*}:\006backup\332A\022backup,update_mask\312A/\n"
          + "\006Backup\022%google.cloud.common.OperationMetadata\032G\312A\023file.googleapis.com\322A.https://www.googleapis.com/auth/cloud-platformB\254\002\n"
          + "\"com.google.cloud.filestore.v1beta1B\032CloudFilestoreSer"
          + "viceProtoP\001ZGgoogle.golang.org/genproto/googleapis/cloud/filestore/v1beta1;filestore\252\002\036Google.Cloud.Filestore.V1Beta1\312\002\036Google\\Cloud\\Filestore\\V1beta1\352A\\\n"
          + "\034file.googleapis.com/Snapshot\022<projects/{proje"
          + "ct}/locations/{location}/snapshots/{snapshot}b\006proto3"
    };
    descriptor =
